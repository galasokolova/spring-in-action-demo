...
import pt.galina.cassandrareactivepersistence.entity.user.service.UserService;
import pt.galina.cassandrareactivepersistence.security.RegistrationForm;
    ...
    public Mono<ServerResponse> processRegistration(ServerRequest request) {
        return request.formData()
                .flatMap(formData -> {
                    ...
                    log.info("👽 Processing registration for user: {}", username);
