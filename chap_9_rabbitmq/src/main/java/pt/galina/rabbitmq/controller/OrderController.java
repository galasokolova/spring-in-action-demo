package pt.galina.rabbitmq.controller;
...
import pt.galina.rabbitmq.config.OrderProps;
import pt.galina.rabbitmq.data.OrderRepository;
import pt.galina.rabbitmq.entity.taco.TacoOrder;
import pt.galina.rabbitmq.entity.user.User;
import pt.galina.rabbitmq.message.RabbitOrderMessagingService;
...
public class OrderController {
    ...
    public OrderController(OrderRepository orderRepo, OrderProps orderProps, RabbitOrderMessagingService messagingService) {
