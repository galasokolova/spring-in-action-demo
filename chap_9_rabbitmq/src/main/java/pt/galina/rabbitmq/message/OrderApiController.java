...
import pt.galina.rabbitmq.dto.TacoOrderDTO;
...
public class OrderApiController {
    ...
    private final RabbitOrderMessagingService jms;
    private final OrderRepository repo;
    private final OrderMessagingService messagingService;

    public OrderApiController(RabbitOrderMessagingService jms, OrderRepository repo, OrderMessagingService messagingService) {
        this.jms = jms;
        this.repo = repo;
