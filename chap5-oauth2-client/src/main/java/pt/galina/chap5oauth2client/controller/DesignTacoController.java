...
import pt.galina.chap5oauth2client.entity.taco.Ingredient.Type;
import pt.galina.chap5oauth2client.entity.taco.Taco;
import pt.galina.chap5oauth2client.entity.taco.TacoOrder;
import pt.galina.chap5oauth2client.entity.user.User;
import pt.galina.chap5oauth2client.data.UserRepository;
...
public class DesignTacoController {
    ...
    public String processTaco(
        ...
        log.debug("Adding taco to order: {}", taco);
        order.addTaco(taco);
